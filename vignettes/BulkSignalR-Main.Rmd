...
```{r printBsrdm , eval=FALSE,cache=FALSE}
...
png("../man/figures/spatialPlot1_clean.png", width = 600, height = 300)
...
png("../man/figures/spatialPlot2_clean.png", width = 600, height = 300)
spatialPlot(scores.red[inter, ], areas, inter,
    ref.plot = TRUE, ref.plot.only = FALSE,
...
png("../man/figures/spatialPlot_separated_clean.png", width = 600, height = 600)
...
spatialIndexPlot(scores.red, areas, "../man/figures/bigplot-BSR.pdf")
```
...
assoc.bsr.corr <- spatialAssociation(scores.red[c(1:25), ], areas, test = "Spearman")

png("../man/figures/spatialAssociation_clean.png", width = 400, height = 400)
